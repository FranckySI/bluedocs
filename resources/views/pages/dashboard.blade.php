...
<style>
  ...
  .bd-dash-title .accent{ color:var(--bd-red); }
  .bd-dash-sub{
    font-size:13.5px;
    color:#5b6b83;
    margin:6px 0 0;
  ...
  .bd-dash-cta:hover, .bd-dash-cta:focus-visible{ background:var(--bd-red); }
  ...
  .bd-panel-head a:hover{ color:var(--bd-red); }
  ...
  .bd-doc-name{ font-weight:600; }
  .bd-doc-meta{ display:block; font-size:11.5px; color:#8393ab; font-family:var(--bd-font-mono); margin-top:2px; }
  ...
  .bd-badge.add{ background:rgba(0,51,102,0.1); color:var(--bd-blue); }
  .bd-badge.edit{ background:rgba(204,0,51,0.1); color:var(--bd-red); }
  .bd-badge.del{ background:#f1f2f5; color:#5b6b83; }

  .bd-user-cell{ display:flex; align-items:center; gap:8px; }
  .bd-mini-avatar{
    width:26px; height:26px; border-radius:50%;
    display:flex; align-items:center; justify-content:center;
    font-family:var(--bd-font-display); font-weight:700; font-size:10.5px;
    color:var(--bd-white); background:var(--bd-blue);
    flex-shrink:0;
  }

  /* ---------- Connexions récentes ---------- */
  .bd-connexions{ list-style:none; margin:0; padding:0; }
  .bd-connexions li{
    display:flex; align-items:center; gap:12px;
    padding:14px 22px;
    border-top:1px solid #eef1f6;
  }
  .bd-connexions li:first-child{ border-top:0; }
  .bd-avatar{
    width:36px; height:36px; border-radius:50%;
    display:flex; align-items:center; justify-content:center;
    font-family:var(--bd-font-display); font-weight:700; font-size:12.5px;
    color:var(--bd-white); background:var(--bd-blue-dark);
    border:2px solid var(--bd-red);
    flex-shrink:0;
  }
  .bd-connexion-info{ flex:1; min-width:0; }
  .bd-connexion-name{ font-size:13.5px; font-weight:600; }
  .bd-connexion-role{ font-size:11.5px; color:#8393ab; }
  .bd-connexion-time{
    font-family:var(--bd-font-mono);
    font-size:11px;
    color:#8393ab;
  ...
  .bd-status-dot.offline{ background:#c7cedb; }

  /* ---------- Répartition par rôle ---------- */
  .bd-panel-body{ padding:20px 22px 22px; }
  .bd-bar-row{ margin-bottom:16px; }
  .bd-bar-row:last-child{ margin-bottom:0; }
  .bd-bar-labels{
    display:flex; justify-content:space-between;
    font-size:12.5px; margin-bottom:6px;
  }
  .bd-bar-labels .name{ font-weight:600; }
  .bd-bar-labels .count{ color:#8393ab; font-family:var(--bd-font-mono); }
  .bd-bar-track{
  ...
  .bd-bar-fill.accent{ background:var(--bd-red); }

  @media (max-width:960px){
    .bd-stats{ grid-template-columns:repeat(2, 1fr); }
    .bd-grid{ grid-template-columns:1fr; }
    .bd-dash{ padding:30px 20px 60px; }
  }
</style>
  ...
  <div class="bd-grid">
    ...
    <div class="bd-panel">
      ...
      <ul class="bd-connexions">
        <!-- TODO backend : foreach ($connexions as $c) ... -->
        <li>
          <div class="bd-avatar">AD</div>
          <div class="bd-connexion-info">
            <div class="bd-connexion-name">Admin</div>
            <div class="bd-connexion-role">Administrateur</div>
          </div>
          <span class="bd-status-dot" title="En ligne"></span>
          <span class="bd-connexion-time">09:14</span>
        </li>
        <li>
          <div class="bd-avatar" style="border-color:var(--bd-blue);">EM</div>
          <div class="bd-connexion-info">
            <div class="bd-connexion-name">E. Martin</div>
            <div class="bd-connexion-role">Editeur</div>
          </div>
          <span class="bd-status-dot" title="En ligne"></span>
          <span class="bd-connexion-time">08:47</span>
        </li>
        <li>
          <div class="bd-avatar" style="border-color:var(--bd-blue);">SL</div>
          <div class="bd-connexion-info">
            <div class="bd-connexion-name">S. Leroy</div>
            <div class="bd-connexion-role">Editeur</div>
          </div>
          <span class="bd-status-dot offline" title="Hors ligne"></span>
          <span class="bd-connexion-time">Hier, 17:32</span>
        </li>
        <li>
          <div class="bd-avatar" style="border-color:var(--bd-blue);">KB</div>
          <div class="bd-connexion-info">
            <div class="bd-connexion-name">K. Bernard</div>
            <div class="bd-connexion-role">Editeur</div>
          </div>
          <span class="bd-status-dot offline" title="Hors ligne"></span>
          <span class="bd-connexion-time">Hier, 14:05</span>
        </li>
      </ul>
    </div>
