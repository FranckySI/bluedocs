        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                tinymce.init({
                    ...
                    // Configuration essentielle pour les liens Laravel :
                    relative_urls: false, // Garde le slash '/' au début du lien
                    remove_script_host: true, // Évite d'ajouter "http://localhost" en dur dans la BDD
                    convert_urls: false
                });
            });
        </script>
